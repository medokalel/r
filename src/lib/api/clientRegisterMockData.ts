...
export const MOCK_CLIENT_REGISTER_ENTRIES: ClientRegisterEntry[] = [
  ...
  { id: '3', code: 'CL-0003', name: 'Gulf Medical Supplies', countryCode: 'AE', contactName: 'Aisha Hassan', contactEmail: 'aisha@gulfmedical.example', applicationNumber: 'APP-0022', assignedTo: { name: 'Karim Nabil' }, status: 'ASSESSMENT', createdAt: '2026-04-08' },
  { id: '4', code: 'CL-0004', name: 'Desert Tech Solutions', countryCode: 'SA', contactName: 'Omar Farouk', contactEmail: 'omar@deserttech.example', applicationNumber: 'APP-0021', assignedTo: { name: 'Huda Saeed' }, status: 'ASSESSMENT', createdAt: '2026-04-05' },
  ...
  { id: '6', code: 'CL-0006', name: 'Red Sea Logistics', countryCode: 'SA', contactName: 'Hassan Ali', contactEmail: 'hassan@redsealog.example', applicationNumber: 'APP-0019', assignedTo: { name: 'Rania Fathy' }, status: 'IN_PROGRESS', createdAt: '2026-03-28' },
  { id: '7', code: 'CL-0007', name: 'Green Valley Farms', countryCode: 'AE', contactName: 'Fatima Al-Suwaidi', contactEmail: 'fatima@greenvalley.example', applicationNumber: 'APP-0018', assignedTo: { name: 'Salem Al-Nuaimi' }, status: 'IN_PROGRESS', createdAt: '2026-03-25' },
  ...
  { id: '11', code: 'CL-0011', name: 'Nile Steel Works', countryCode: 'EG', contactName: 'Mona Adel', contactEmail: 'mona@nilesteel.example', applicationNumber: 'APP-0014', assignedTo: { name: 'Marwan Al-Zaabi' }, status: 'IN_PROGRESS', createdAt: '2026-03-09' },
  ...
  { id: '14', code: 'CL-0014', name: 'Oasis Dairy Products', countryCode: 'SA', contactName: 'Tariq Al-Otaibi', contactEmail: 'tariq@oasisdairy.example', applicationNumber: 'APP-0011', assignedTo: { name: 'Noor Al-Sulaiti' }, status: 'ASSESSMENT', createdAt: '2026-02-25' },
  ...
  { id: '16', code: 'CL-0016', name: 'Marina Construction Co.', countryCode: 'AE', contactName: 'Salem Al-Nuaimi', contactEmail: 'salem@marinaconstruct.example', applicationNumber: 'APP-0009', assignedTo: { name: 'Arjun Verma' }, status: 'IN_PROGRESS', createdAt: '2026-02-16' },
  ...
  { id: '19', code: 'CL-0019', name: 'Alexandria Shipping Lines', countryCode: 'EG', contactName: 'Heba Sami', contactEmail: 'heba@alexshipping.example', applicationNumber: 'APP-0006', assignedTo: { name: 'Tariq Al-Otaibi' }, status: 'ASSESSMENT', createdAt: '2026-02-03' },
  ...
  { id: '21', code: 'CL-0021', name: 'Dammam Steel Fabrication', countryCode: 'SA', contactName: 'Reem Al-Dosari', contactEmail: 'reem@dammamsteel.example', applicationNumber: 'APP-0004', assignedTo: { name: 'Salem Al-Nuaimi' }, status: 'IN_PROGRESS', createdAt: '2026-01-24' },
  ...
  { id: '24', code: 'CL-0024', name: 'Sharjah Building Materials', countryCode: 'AE', contactName: 'Yasmin Al-Shamsi', contactEmail: 'yasmin@sharjahbm.example', applicationNumber: 'APP-0001', assignedTo: { name: 'Heba Sami' }, status: 'IN_PROGRESS', createdAt: '2026-01-10' },
]