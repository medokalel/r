/**
 * Data for the "Create New AB Account" (Certification Body) registration
...
// TODO: replace with a real lookup once the backend defines the AB type taxonomy
export const AB_TYPE_OPTIONS: AbOption[] = [
  { value: 'PRODUCT_CERTIFICATION', labelKey: 'register.ab.abTypes.product' },
  { value: 'MANAGEMENT_SYSTEM_CERTIFICATION', labelKey: 'register.ab.abTypes.managementSystem' },
  { value: 'PERSONNEL_CERTIFICATION', labelKey: 'register.ab.abTypes.personnel' },
  { value: 'INSPECTION_BODY', labelKey: 'register.ab.abTypes.inspectionBody' },
]

// TODO: replace with a real lookup once the backend defines contact roles
export const AB_ROLE_OPTIONS: AbOption[] = [
  { value: 'OWNER', labelKey: 'register.ab.roles.owner' },
  { value: 'MANAGER', labelKey: 'register.ab.roles.manager' },
  { value: 'AUTHORIZED_REPRESENTATIVE', labelKey: 'register.ab.roles.authorizedRepresentative' },
]
...
// registered AB legal names (this mock just seeds the "AB Name" field) —
// legal/company names are kept as registered and not translated
export const MOCK_AB_NAMES: { value: string; label: string }[] = [
...
// TODO: replace with a real lookup once the backend exposes the appliable
