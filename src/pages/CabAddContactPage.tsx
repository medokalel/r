    ...
    <CabLayout sidebarVariant="contacts">
      ...
      <main className="flex flex-1 flex-col gap-5 overflow-auto p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="rounded-[16px] border border-[#ececec] bg-white p-6 shadow-none">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              <div className="lg:col-span-7 space-y-1.5">
                ...
                <select
                  ...
                  className="w-full rounded-[10px] border border-[#d8dce5] bg-white px-4 py-2.5 text-[14px] text-neutral-800 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                  required
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-[10px] border border-[#d8dce5] bg-white px-4 py-2.5 text-[14px] text-neutral-900 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="w-28 rounded-[10px] border border-[#d8dce5] bg-white px-3 py-2.5 text-[14px] text-neutral-800 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                  >
                  ...
                  <input
                    ...
                    className="flex-1 rounded-[10px] border border-[#d8dce5] bg-white px-4 py-2.5 text-[14px] text-neutral-900 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <button
              ...
              className="rounded-[var(--radius-sm)] bg-primary px-6 py-2.5 text-[14px] font-medium text-white shadow-sm hover:bg-primary/90 transition-colors disabled:opacity-60"
            >
