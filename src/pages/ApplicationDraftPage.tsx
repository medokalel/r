      ...
      <div className="flex flex-1 flex-col gap-5 overflow-auto p-6">
        <nav className="flex min-w-0 flex-wrap items-center gap-2 text-[13px]" aria-label="breadcrumb">
          <Link to={ROUTES.workspace} className="font-light text-neutral-400 hover:text-primary">
            {t('cab.applicationDraft.breadcrumbWorkspace')}
          </Link>
          <Chevron />
          <Link to={ROUTES.cabApplicationRegister} className="font-light text-neutral-400 hover:text-primary">
            {t('cab.applicationDraft.breadcrumbApplicationRegister')}
          </Link>
          <Chevron />
          <span className="font-medium text-neutral-700">{t('cab.applicationDraft.title')}</span>
        </nav>
