  ...
  return (
    <div className="border-b border-[#f0f0f0] last:border-b-0">
      ...
      >
        ...
        <span
          className={cn(
            'hidden shrink-0 rounded-full px-3 py-1 text-[12px] font-medium sm:inline-flex',
              ...
              <SectionCard title={t('cab.manageCycle.currentCycleTitle', 'Current certification cycle')}>
                <div className="space-y-4">
                  ...
                  <Field label={t('cab.certification.fields.cycleStatus', 'Cycle status')}>
                    <span className="inline-flex items-center gap-2 rounded-full bg-[#eafaf1] px-3 py-1 text-[12px] font-medium text-[#16a34a]">
