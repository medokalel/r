...
export function CabCreateOfferPage() {
  ...
  return (
    <CabLayout sidebarVariant="offers">
      <CabHeader
      ...
      <main className="flex flex-1 flex-col gap-5 overflow-auto p-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-[var(--radius-sm)] border border-[#d8dce5] bg-white px-4 py-2.5 text-[14px] font-medium text-neutral-700 hover:bg-neutral-50 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="rounded-[16px] border border-[#ececec] bg-white p-6 shadow-none space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  readOnly
                  value={client}
                  className="w-full rounded-[10px] border border-[#d8dce5] bg-neutral-50 px-3.5 py-2.5 text-[14px] text-neutral-700 focus:outline-none cursor-not-allowed"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <select
                    ...
                    className={cn(
                      'w-full appearance-none rounded-[10px] border bg-white px-3.5 py-2.5 text-[14px] pr-8 focus:outline-none focus:ring-1 transition-colors',
                      errors.application
                        ? 'border-error-500 text-error-900 focus:border-error-500'
                        : 'border-[#d8dce5] text-neutral-800 focus:border-primary focus:ring-primary'
                    )}
                  >
            ...
            <div className="grid grid-cols-2 gap-y-3 gap-x-4 pt-2 text-[13px] rounded-[12px] bg-[#f8fafc] border border-[#ececec] p-4">
              <div>
          ...
          <div className="rounded-[16px] border border-[#ececec] bg-white p-6 shadow-none space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-[13px] font-semibold text-neutral-800">Offer number</label>
                <input
                  type="text"
                  readOnly
                  value={offerNumber}
                  className="w-full rounded-[10px] border border-[#d8dce5] bg-neutral-50 px-3.5 py-2.5 text-[14px] text-neutral-600 font-mono focus:outline-none cursor-not-allowed"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none rounded-[10px] border border-[#d8dce5] bg-white px-3.5 py-2.5 text-[14px] text-neutral-900 pr-8 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary transition-colors"
                  >
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className={cn(
                    'w-full rounded-[10px] border bg-white px-3.5 py-2.5 text-[14px] focus:outline-none focus:ring-1 transition-colors',
                    errors.validUntil
                      ? 'border-error-500 text-error-900 focus:border-error-500'
                      : 'border-[#d8dce5] text-neutral-900 focus:border-primary focus:ring-primary'
                  )}
                />
                {errors.validUntil && (
            ...
            <div className="space-y-1.5">
              <label className="text-[13px] font-semibold text-neutral-800">Notes</label>
              <textarea
                rows={3}
                value={notes}
                onChange={(e) => setNotes(e.target.value)}
                placeholder="Add any internal notes (optional)..."
                className="w-full rounded-[10px] border border-[#d8dce5] bg-white px-3.5 py-2.5 text-[14px] text-neutral-900 placeholder:text-neutral-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary transition-colors resize-none"
              />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-8 space-y-3">
                ...
                <table className="w-full border-collapse text-start text-[14px]">
                  <thead>
                    <tr className="bg-[#1236a3] text-white">
                      ...
                      <th className="px-4 py-3.5 text-start font-medium">Description</th>
                      <th className="px-4 py-3.5 text-end font-medium">Amount ({currency})</th>
                      <th className="w-12 px-4 py-3.5 text-center font-medium"></th>
                    </tr>
                  </thead>
                  <tbody>
                    {fees.map((item, index) => (
                      <tr key={item.id} className={cn('hover:bg-[#e8edfc]/50 transition-colors', index % 2 === 1 ? 'bg-[#f9fafc]' : '')}>
                        ...
                        <td className="px-4 py-3.5 text-neutral-900 font-semibold">{item.description}</td>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-[10px] border border-primary/30 bg-[#e8edfc] px-4 py-2 text-[13px] font-semibold text-primary hover:bg-primary/20 transition-colors"
              >
            ...
            {/* Totals Summary Box */}
            <div className="lg:col-span-4 rounded-[12px] bg-[#f8fafc] p-5 border border-[#ececec] space-y-3">
        ...
        <div className="rounded-[16px] border border-[#ececec] bg-white shadow-none overflow-hidden">
          ...
          {moreDetailsOpen && (
            <div className="p-6 border-t border-[#ececec] space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                {/* Left Column Fields */}
                <div className="lg:col-span-6 space-y-4">
                  {/* Travel costs */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                    <label className="text-[13px] font-semibold text-neutral-800">Travel costs</label>
                    <div className="relative">
                      <select
                        value={travelCosts}
                        onChange={(e: any) => setTravelCosts(e.target.value)}
                        className="w-full appearance-none rounded-[10px] border border-[#d8dce5] bg-white px-3.5 py-2.5 text-[14px] text-neutral-900 pr-8 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                      >
                  ...
                  <div className="space-y-1.5 pt-1">
                    ...
                    {termsAttachment ? (
                      <div className="flex items-center justify-between p-3 bg-[#f8fafc] border border-[#ececec] rounded-[10px] text-[13px]">
                      ...
                      <button
                        ...
                        className="w-full py-3 px-4 border-2 border-dashed border-[#d8dce5] rounded-[10px] text-[13px] text-neutral-500 hover:bg-neutral-50 flex items-center justify-center gap-2"
                      >
                ...
                <div className="lg:col-span-6 space-y-4">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <label className="text-[13px] font-semibold text-neutral-800">Approval route</label>
                      <div className="relative w-52">
                        <select
                          value={approvalRoute}
                          onChange={(e) => setApprovalRoute(e.target.value)}
                          className="w-full appearance-none rounded-[8px] border border-[#d8dce5] bg-white px-3 py-1.5 text-[13px] text-neutral-800 pr-7 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                        >
                    ...
                    <div className="rounded-[12px] bg-[#f8fafc] p-4 border border-[#ececec] space-y-3">
                  ...
                  {/* Info Notice Banner */}
                  <div className="p-3.5 bg-[#e8edfc] border border-[#c5d7fa] rounded-[12px] flex items-start gap-2.5 text-[13px] text-primary leading-relaxed font-medium">
        ...
        <div className="flex items-center justify-between pt-2 pb-8">
          <button
            ...
            className="rounded-[var(--radius-sm)] border border-[#d8dce5] bg-white px-5 py-2.5 text-[14px] font-medium text-neutral-700 hover:bg-neutral-50 transition-colors"
          >
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="rounded-[var(--radius-sm)] border border-primary text-primary hover:bg-[#e8edfc] px-5 py-2.5 text-[14px] font-medium transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              className="rounded-[var(--radius-sm)] bg-primary hover:bg-primary/90 text-white px-6 py-2.5 text-[14px] font-medium transition-colors disabled:opacity-50"
            >
            ...
            <div className="bg-white rounded-[16px] shadow-2xl border border-[#ececec] w-full max-w-sm p-5 space-y-4">
              ...
              <div className="flex items-center justify-end gap-2 pt-1">
                ...
                <button
                  type="button"
                  onClick={() => navigate(ROUTES.cabOffers)}
                  className="rounded-[10px] bg-error-600 hover:bg-error-700 text-white px-4 py-2 text-[13px] font-semibold shadow-sm"
                >
                  Discard
                </button>
              </div>
